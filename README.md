...
[![npm version](https://img.shields.io/npm/v/chromium-anti-detect.svg)](https://www.npmjs.com/package/chromium-anti-detect)
...
```bash
npm install chromium-anti-detect playwright-core
# hoặc
yarn add chromium-anti-detect playwright-core
```
...
```ts
import { Chromium } from 'chromium-anti-detect';
...
Lấy fingerprint sau đó truyền vào:
...
**Tùy chọn DNS** — dùng khi cần kiểm soát DNS leak:
...
Thắc mắc về Fingerprint/Key — tham khảo [tài liệu chính thức Bablosoft](https://wiki.bablosoft.com).